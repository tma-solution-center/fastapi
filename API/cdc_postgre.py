...
LOGIN_URL = APIUtils.NIFI_URL + "/access/token"
...
@router.post("/create_processor_group/", tags=["API CDC POSTGRES"])
...
@router.post("/create-cdc-postgre/{id}", tags=["API CDC POSTGRES"])
...
@router.post("/start-job/{id}", tags=["API CDC POSTGRES"])
...
@router.post("/stop-job/{id}", tags=["API CDC POSTGRES"])
...
@router.put("/enable-dbcp-connection-pool/{id}", tags=["API CDC POSTGRES"])
...
@router.put("/disable-dbcp-connection-pool/{id}", tags=["API CDC POSTGRES"])
...
@router.post("/process-groups/{id}/empty-all-connections-requests", tags=["API CDC POSTGRES"])
...
@router.delete("/delete-process-group/{id}", tags=["API CDC POSTGRES"])
